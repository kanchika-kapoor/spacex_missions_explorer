 ...
 * });
 */
export function useLaunchProfileQuery(baseOptions: Apollo.QueryHookOptions<LaunchProfileQuery, LaunchProfileQueryVariables> & ({ variables: LaunchProfileQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function useLaunchProfileSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<LaunchProfileQuery, LaunchProfileQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<LaunchProfileQuery, LaunchProfileQueryVariables>(LaunchProfileDocument, options);
        }
...
export type LaunchProfileSuspenseQueryHookResult = ReturnType<typeof useLaunchProfileSuspenseQuery>;
...
export function useLaunchListSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<LaunchListQuery, LaunchListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
